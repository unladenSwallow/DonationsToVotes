...
public class dbInsert {
    ...
    public void updateVotes(List<List<String>> csv) throws SQLException {
        ...
        long startTime = System.currentTimeMillis();
        String insert = "insert into votes (POL_ID,BILL_NAME,Vote,Sponsor) SELECT POL_ID,BILL_NAME,?,? FROM politicians,bills WHERE PoliticianName LIKE ? AND BILL_NAME LIKE ?";
